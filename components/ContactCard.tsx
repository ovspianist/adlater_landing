  ...
  return (
    <div className="flex flex-col items-center w-full py-10">
      {/* <div className=" p-[1px] rounded-2xl bg-gradient-to-b from-zinc-500 to-transparent"> */}
        <div className="flex flex-col w-11/12 lg:w-full items-center justify-center 
        gap-2 w-8/12 p-8 max-w-xl bg-[rgba(50,50,50,0.3)] backdrop-blur-lg rounded-2xl
        border-t-[1px] border-t-neutral-600 shadow-xl shadow-[rgba(0,0,0,0.15)]">
          <div className="text-lg sm:text-2xl font-medium pb-4 text-neutral-300 select-none">Contact</div>
