    ...
    <div className="flex flex-col items-center w-full py-10">
      {/* <div className=" p-[1px] rounded-2xl bg-gradient-to-b from-zinc-500 to-transparent"> */}
        ...
        border-t-[1px] border-t-neutral-600 shadow-xl shadow-[rgba(0,0,0,0.15)]">
          <div className="text-2xl font-medium pb-4 text-neutral-300 select-none">Contact</div>
            <div className="flex flex-row items-center gap-8">
              <div className="text-lg font-medium opacity-40 w-48 text-right select-none"> General Inquiry </div>
              <div className="text-lg font-thin w-48 text-left"> info@adlater.co.uk </div>
            </div>
            <div className="flex flex-row items-center gap-8">
              <div className="text-lg font-medium opacity-40 w-48 text-right select-none"> Investor </div>
